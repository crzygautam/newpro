...
// console.log();
console.log('my all products : ' , jsonData );


function openURL() {
    window.open("https://youtube.com/shorts/E4vQKSHpXDE?feature=share", "_blank");
  }
  
 // setInterval(openURL, 10000);
  


function addProduct(){
    // event.preventDefault()
    console.log("fdtfgfsgtfygtfdydtf")
   const pName = document.getElementById('pname').value;
   const desc = document.getElementById('desc').value;
   const qty = document.getElementById('qty').value;
   const obj = {name:pName, desc:desc, qty:qty};
   console.log(obj);
   allProducts.push(obj)
   console.log(allProducts)
    console.log(` product name : ${pName} my descriptuoinjhifr hr : ${desc} , qty : ${qty}`);
}